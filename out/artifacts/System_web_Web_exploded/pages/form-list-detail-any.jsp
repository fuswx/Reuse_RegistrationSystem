	...
	<div class="wrapper">
						...
						<div class="table-box">
							...
							<div class="box-tools pull-right">
								<div class="has-feedback">
									<input type="text" class="form-control input-sm" placeholder="列名:内容+回车" id="search" onkeydown="searchUser(this)" value="${data}">
									<span
					...
					<div class="box-footer">
						...
						<div class="box-tools pull-right">
							<ul class="pagination" id="pageNum">
								<li><a href="${pageContext.request.contextPath}/form/findByAny.do?formId=${formId}&formName=${formName}&data=${data}&pageNum=1&pageSize=${pageInfo.pageSize}" aria-label="Previous">首页</a></li>
								<li><a href="${pageContext.request.contextPath}/form/findByAny.do?formId=${formId}&formName=${formName}&data=${data}&pageNum=${pageInfo.pageNum-1}&pageSize=${pageInfo.pageSize}">上一页</a></li>
								<c:forEach begin="1" end="${pageInfo.pages}" varStatus="status">
									<li><a href="${pageContext.request.contextPath}/form/findByAny.do?formId=${formId}&formName=${formName}&data=${data}&pageNum=${status.index}&pageSize=${pageInfo.pageSize}">${status.index}</a> </li>
								</c:forEach>
								<li><a href="${pageContext.request.contextPath}/form/findByAny.do?formId=${formId}&formName=${formName}&data=${data}&pageNum=${pageInfo.pageNum+1}&pageSize=${pageInfo.pageSize}">下一页</a></li>
								<li><a href="${pageContext.request.contextPath}/form/findByAny.do?formId=${formId}&formName=${formName}&data=${data}&pageNum=${pageInfo.pageSize}&pageSize=${pageInfo.pageSize}" aria-label="Next">尾页</a></li>
							</ul>
						</div>
		...
		<script>
			...
			function deleteForm(formId){
				if (confirm("您确定要删除吗?")){
					location.href="${pageContext.request.contextPath}/form/formDelete.do?totalFormId=${formId}&formName=${formName}&formId="+formId;
				}else {
					$("#delete").prop("href","#");
				}
			}
