    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="error-page">
                <img src="${pageContext.request.contextPath}/img/submit-success.png" style="margin-left: -100px;display: block">
                ...
                <div class="error-content">
                    ...
                    <p style="margin-left: 0px!important;">
                        您已经提交成功, 你可以<br> <a href="${pageContext.request.contextPath}/index.jsp" style="margin-left: -10px">返回到首页</a>或
