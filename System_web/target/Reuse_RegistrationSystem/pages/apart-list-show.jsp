...
<body class="hold-transition skin-blue-light sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<h1>
				提交成功 <small>联系部门</small>
			</h1>
			<ol class="breadcrumb">
				<li><a href="${pageContext.request.contextPath}/index.jsp"><i
						class="fa fa-dashboard"></i> 首页</a></li>
				<li><a href="${pageContext.request.contextPath}/pages/submit-success.jsp">提交成功</a></li>

				<li class="active">联系部门</li>
			</ol>
			</section>
			<!-- 内容头部 /-->
				...
				<div class="box box-primary">
					<div class="box-header with-border">
						<span class="box-title" style="color: rgba(0,0,0,0.5);font-weight: 700;font-size: 14px">请按照志愿加入以下部门qq群</span>
					</div>
					...
					<div class="box-footer">
						...
						<div class="box-tools pull-right" id="pageChangeDiv">
							<ul class="pagination" id="pageNum">
								<li><a href="${pageContext.request.contextPath}/apart/userFindAll.do?pageNum=1&pageSize=${pageInfo.pageSize}" aria-label="Previous">首页</a></li>
								<li><a href="${pageContext.request.contextPath}/apart/userFindAll.do?pageNum=${pageInfo.pageNum-1}&pageSize=${pageInfo.pageSize}">上一页</a></li>
								<c:forEach begin="1" end="${pageInfo.pages}" varStatus="status">
									<li><a href="${pageContext.request.contextPath}/apart/userFindAll.do?pageNum=${status.index}&pageSize=${pageInfo.pageSize}">${status.index}</a> </li>
								</c:forEach>
								<li><a href="${pageContext.request.contextPath}/apart/userFindAll.do?pageNum=${pageInfo.pageNum+1}&pageSize=${pageInfo.pageSize}">下一页</a></li>
								<li><a href="${pageContext.request.contextPath}/apart/userFindAll.do?pageNum=${pageInfo.pageSize}&pageSize=${pageInfo.pageSize}" aria-label="Next">尾页</a></li>
							</ul>
						</div>
	...
	<script src="${pageContext.request.contextPath}/js/header-common.js"></script>
		<script>
			...
			function changePageSize() {
				...
				//向服务器发送请求，改变每页显示条数
				location.href = "${pageContext.request.contextPath}/apart/userFindAll.do?pageNum=${pageInfo.pageNum}&pageSize="+pageSize ;
			}
