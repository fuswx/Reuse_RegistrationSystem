    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="error-page" style="width: 90%">
                <img src="${pageContext.request.contextPath}/img/submit-success.png" style="display: block;width: 95%">

                <div class="error-content" style="margin-left: 35%">
                    <a href="${pageContext.request.contextPath}/apart/userFindAll.do?pageNum=1&pageSize=5"> <h3><i class="fa fa-user-plus text-yellow"></i> 联系部门</h3></a>
                </div>
                <!-- /.error-content -->
            </div>
            <!-- /.error-page -->
