...
<script>
    ...
    $(function (){
        ...
        mypost=$.post("${pageContext.request.contextPath}/form/update.do",{id:${formId}},function (inputList){
            $("#title-text").val(inputList.title);
            for (var i = 0; i < inputList.addInputs.length; i++) {
                ...
                $("#right-box-content").children(":last-child").children(":first-child").prepend("<span style='display: block;float: left'>"+titleIndex+".</span>")
                titleIndex++
            }
            status=true;
        })
