...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="error-page" style="width: 90%">
                <img src="${pageContext.request.contextPath}/img/submit-success.png" style="display: block">

                <div class="error-content">
                    <a href="${pageContext.request.contextPath}/index.jsp"> <h3><i class="fa fa-user-plus text-yellow"></i> 返回首页</h3></a>

                    <p style="margin-left: 0px!important;">
                        您已经提交成功, 你可以<br> <a href="${pageContext.request.contextPath}/index.jsp" style="margin-left: -10px;width: 95%">返回到首页</a>或
                        <a href="${pageContext.request.contextPath}/form/findAll.do">查看所有表单</a>
                    </p>
